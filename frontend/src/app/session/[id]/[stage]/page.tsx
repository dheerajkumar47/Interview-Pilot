...
const GREETINGS: Record<string, string> = {
  ...
  technical: "Welcome to Technical Practice! To make this session effective, I'll start with 4-5 quick questions to tailor the interview to your needs. First, what specifically is the job role you are targeting?",
