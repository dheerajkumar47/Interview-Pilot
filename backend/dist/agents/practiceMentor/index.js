...
exports.conductPracticeSession = conductPracticeSession;
exports.conductPracticeDiscovery = conductPracticeDiscovery;
...
async function conductPracticeSession(messages, context) {
    ...
    const response = await (0, ai_service_1.callAI)(systemPrompt, messages, { temperature: 0.7, maxTokens: 1024 });
    return response.content;
}
async function conductPracticeDiscovery(messages) {
    const response = await (0, ai_service_1.callAI)(PRACTICE_DISCOVERY_PROMPT, messages, { temperature: 0.7, maxTokens: 512 });
    return response.content;
}
