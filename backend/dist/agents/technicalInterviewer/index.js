...
exports.conductTechnicalInterview = conductTechnicalInterview;
exports.conductSystemDesign = conductSystemDesign;
exports.conductDiscovery = conductDiscovery;
...
async function conductTechnicalInterview(messages, context) {
    ...
    const response = await (0, ai_service_1.callAI)(systemPrompt, messages, { temperature: 0.8, maxTokens: 2048 });
    return response.content;
}
async function conductSystemDesign(messages, context) {
...
async function conductDiscovery(messages) {
    const response = await (0, ai_service_1.callAI)(DISCOVERY_PROMPT, messages, { temperature: 0.7, maxTokens: 512 });
    return response.content;
}
